...
export function RoundReview({ round }: { round: MomRound }) {
  ...
  return <><p className="sub">채점 {score.checked}/{round.questionCount} · 맞음 {score.correct}개</p><AnswerSheet round={round} onResultChange={(itemId, result) => setResults((value) => ({ ...value, [itemId]: result }))} /></>;
}
